...
## Overview
This lesson is inspired by the [Programming in Python lessons](https://v4.software-carpentry.org/python/index.html) from the [Software Carpentry organization](http://software-carpentry.org/).
